...
def mainmenu(window, first) :
    ...
    window.title('Rainbow Cheat V3.02 by ALittlePatate')
...
def buttons(window) :
    ...
    Aimbot.place(relx=1, x=-420, y=100, anchor=NE)
    #Config du Aimbot
    Aimbot_conf = Button(window, text="Config", fg='#000000', font=(40), command= lambda: aimbot_conf())
    Aimbot_conf.place(relx=1, x=-480, y=100, anchor=NE)
    ...
    Wallhack.place(relx=1, x=-240, y=100, anchor=NE)
    #Config du Wallhack
    Wallhack_conf = Button(window, text="Config", fg='#000000', font=(40), command= lambda: wallhack_conf())
    Wallhack_conf.place(relx=1, x=-315, y=100, anchor=NE)
    ...
    Bhop.place(relx=1, x=-420, y=150, anchor=NE)
    ...
    Noflash.place(relx=1, x=-420, y=200, anchor=NE)
    ...
    RadarHack.place(relx=1, x=-420, y=250, anchor=NE)
    ...
    MoneyHack.place(relx=1, x=-272, y=200, anchor=NE)
    ...
    THP.place(relx=1, x=-25, y=100, anchor=NE)
    #Config du 3p
    THP_conf = Button(window, text="Config", fg='#000000', font=(40), command= lambda: thp_conf())
    THP_conf.place(relx=1, x=-125, y=100, anchor=NE)
